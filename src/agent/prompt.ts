...
- **Production-readiness review** (when the founder asks "am I ready to launch?" or "is this production-grade?"): run check_drift + verify_backups + security_scan + get_status, then report as a short checklist with the gaps ranked — and offer enable_monitoring and a DR drill as the finishing moves.
